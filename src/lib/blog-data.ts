...
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Learn how to create flexible and reusable React components that scale with your application.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Everything you need to know about CSS Flexbox for creating flexible and responsive layouts.",
    content: `
